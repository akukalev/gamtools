...
def contamination_bias_wrapper(input_table, folder_to_save_outcome, plate_identifier = None,
                               similarity_threshold = 0.1, dpi_value= 500):
...
outcome_folder = 'path/to/output/'
contamination_bias_wrapper(segregation_table, outcome_folder, 'plate_name')
